...
export default function ToolTip({title} : {title : string}) {
    return (
        <div 
            data-tooltip
            className="absolute left-1/2 -translate-x-1/2 z-0 top-[135%] bg-primary-dark/95 text-bg text-xs px-4 py-2 rounded transition-opacity delay-700 pointer-events-none opacity-0 group-has-[:hover]:opacity-100"
        >
