...
export default function SearchBar() {
    ...
    return (
        <div className="grid gap-0 text-primary/70 mb-3">

            <div className="flex items-stretch border border-primary/20 rounded-lg has-[input:focus]:border-primary/70 ">
            ...
            <div 
                className={`
                    ...
                    ${ showFilters ? 'px-3 md:px-6 py-6 max-h-[500px] border-primary/10' : 'p-0 max-h-[0px] border-transparent'}
                `}
            >
                <button
